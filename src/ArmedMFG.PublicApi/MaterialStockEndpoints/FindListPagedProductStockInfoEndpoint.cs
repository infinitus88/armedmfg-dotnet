...
public class FindListPagedMaterialStockInfoEndpoint : IEndpoint<IResult, FindListPagedMaterialStockInfoRequest>
{
    ...
    public async Task<IResult> HandleAsync(FindListPagedMaterialStockInfoRequest request)
    {
        var response = new FindListPagedMaterialStockInfoResponse(request.CorrelationId());
    ...
    {
        app.MapPost("api/material-stocks/find",
                async ([FromBody]FindListPagedMaterialStockInfoRequest request) =>
                {
                    return await HandleAsync(request);
                })
            .Produces<FindListPagedMaterialStockInfoResponse>()
